  ...
  void TFTkeypadSubsystemFunction(void *data)
{
    ...
    for (uint8_t b=0; b<12; b++) {
      ...
      if (buttons[b].justPressed()) {
          ...
          buttons[7].initButton(&tft, 280, 55, 150, 20, ILI9341_GREEN, ILI9341_LIGHTGREY, ILI9341_GREEN,
                        "Acknowledge", 1); 
  ...
  void WarningAlarmSubsystemFunction(void *data)
{
    ...
    unsigned int EKGFreq = *warningAlarmData->EKGRawBufPtr;
...
//    
    ...
    if (BpFlashCounter%2 == 0) {
      tft.print(*(displayData->sysCorrectedPtr));
    } else {
      tft.print("  ");
    }
    ...
    tft.print(*(unsigned char*)(displayData->EKGFrequencyBufPtr));
    tft.setTextColor(GREEN); //tft.setTextSize(2);
    tft.println(">");
    tft.println(" ");
  ...
  void schedulerSubsystemFunction(void* data) {
    ...
    SchedulerSubsystemData* scheduleData = (SchedulerSubsystemData*) data;
     ...
     //===============================EKG CAPTURE============================
      ...
      EKGCSD.EKGRawBufPtr = &EKGRawBufMock;
     ...
     //===============================EKG PROCESS============================
      ...
      EKGPSD.EKGRawBufPtr = &EKGRawBufMock;
      EKGPSD.EKGFrequencyBufPtr = &EKGFreqBufMock;
    ...
    //================================== COMPUTE==============================
      ...
      wasd.EKGRawBufPtr = &EKGRawBufMock;
     ...
     //================================= DISPLAY===========================
      ...
      dsd.EKGFrequencyBufPtr = &EKGFreqBufMock;
      ...
      dsd.measurementSelectionPtr = &measurementSelection;
